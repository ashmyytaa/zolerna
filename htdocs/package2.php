...
<body>
	...
	<?php
			...
			if(isset($_POST['updateDescription'])){
				...
				$database->updatePackageDescription($_POST['packageDescriptionText'],"Corporate");
				echo '<script type="text/javascript">toastr.success("Description Updated")</script>';
				$packageResponse=$database->getPackageDataByName("Corporate");
 ...
 <div  class="container" style="background-color: grey; width: 50%; height: 82%; margin-top: 70px; margin-left: 500px; margin-right: 500px; margin-bottom: 900px;border-radius: 15px;     opacity: 0.7; padding: 10px; background-attachment: fixed;  ">
            ...
            <div class = "package-row"> 
             ...
             <div class = "package-col" style="width: 900px; margin-top: 80px; margin-left:30px;  margin-right:30px; margin-bottom: 100px; font-size: 25px; padding-top: 10px;">
                ...
                <i class="fas fa-cart-plus" >
                    ...
                    <br>
                    <br>
                    <a href="cart.php?package_name=Corporate" style="text-decoration: none ; color: white ; border-radius: 20px; padding: 10px; background: #119656; font-size: 30px;">Purchase</a>
                </i>
